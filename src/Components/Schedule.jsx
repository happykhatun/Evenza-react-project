                    ...
                    <div>
                        ...
                        <div className='lg:w-125 w-full bg-white/20 h-20 rounded-full p-2.5 lg:flex-row flex flex-col justify-between items-center text-white font-bold text-[20px]  gap-6 lg:gap-0 mt-20 mb-25 mx-auto '>
                            <button
                                ...
                                className={`py-4.5 px-8.5 lg:w-auto w-full rounded-full  transition-all duration-300 ease-linear lg:bg-transparent
                                 ${activeDay === "day1"
                                        ? "text-white"
                        ...
                        {activeDay === "day2" && (
                            <div>
                                <ScheduleCard
                                    ...
                                    time="9:00 AM - 5:30 PM"
                                    date="22 March 2025"
                                    title="Startup Networking & Investor Meetup"
                                />
                                <hr className='border border-white/10 my-10' />
                                <ScheduleCard
                                    image={schedule_img_2}
                                ...
                                <ScheduleCard
                                    ...
                                    time="8:30 AM - 6:00 PM"
                                    date="20 June 2025"
                                    title="Future of Marketing Conference"
                                />
                                <hr className='border border-white/10 my-10' />
                                <ScheduleCard
                                    image={schedule_img_2}
                        ...
                        {activeDay === "day3" && (
                            <div>
                                ...
                                <ScheduleCard
                                    ...
                                    time="10:00 AM - 4:00 PM"
                                    date="05 May 2025"
                                    title="Frontend Developer Summit"
                                />
                                <hr className='border border-white/10 my-10' />
                                <ScheduleCard
                                    image={schedule_img_3}
                                    time="8:30 AM - 6:00 PM"
                                    date="20 June 2025"
                                    title="Global Tech Networking Event"
                                />
                                <hr className='border border-white/10 my-10' />
                                <ScheduleCard
                                    image={schedule_img_3}
